...
import type { AutoBetConfig } from '../types';
import {
  BetAmountInput,
  BetModeSelector,
  NumberOfBetsInput,
...
export const DiceControls = memo(function DiceControls({
  betMode,
  onBetModeChange,
  betAmount,
  onBetAmountChange,
  ...
  const controlsDisabled = disabled || isRolling || (betMode === 'auto' && isAutoPlaying);
  ...
  return (
    <div className="flex w-[380px] shrink-0 flex-col rounded-12 rounded-r-none bg-dark-700 p-32 scrollbar-none">
      ...
      <div className="mt-auto">
        <div className="mb-16 flex items-center justify-between text-b-md">
          ...
          <span className="flex items-center gap-4">
            ...
            <span className="font-semibold text-light-000">{profitOnWin.toFixed(2)}</span>
          </span>
        </div>

        <ActionButton
          onClick={onActionClick}
          isLoading={betMode === 'auto' && isAutoPlaying}
          disabled={disabled}
        >
          {betMode === 'auto'
            ? isAutoPlaying
